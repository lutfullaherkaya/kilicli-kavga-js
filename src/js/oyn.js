...
export class Sprite {
    ...
    resim;
    yonuSagdir;
    sonundaSonSahneyiTut;
    kacSahnedeResimDegisir;
    suankiSahne;
    gercekKacSahnedeResimDegistir;
    birKereTamAnimasyonOldu;
...
export class Savasci {
    ...
    silahKutusu;
    saldiriHasari;
    spriteler; // todo: bunu dynamic typeli yap
    sprite;
    sonluEylemler;
    suanYapilanEylem;
    kanSpritesi;
    kanAkiyor;
    alternatifSaldiri;
    constructor(tuval, { renk = '', pozisyon = { x: 0, y: 0 }, sagaBakiyor = false, kontroller, genislik, yukseklik, isim, canCubuguID, canCubuguIsimID, spriteler, }) {
        this.tuval = tuval;
