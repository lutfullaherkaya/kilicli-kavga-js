<template>
    <div class="arayuz-mobil-komponenti" ref="arayuzMobilKomponenti">
        ...
        <div class="sag-buton sag-saldiri-butonu aspect-square" @mousedown="saldirt" @touchstart="saldirt">
        ...
        <div class="sag-buton sag-takla-at-butonu aspect-square" @mousedown="taklaAttir" @touchstart="taklaAttir">
